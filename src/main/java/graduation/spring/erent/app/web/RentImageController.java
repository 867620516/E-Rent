...
public class RentImageController {
    ...
    @RequestMapping("/api/uploadIcon")
    public Result uploadIcon(@RequestParam("pic") MultipartFile picture, String id) throws FileNotFoundException {
        ...
        try {
            ...
            user.setIcon("http://localhost:8888/" + fileName);
